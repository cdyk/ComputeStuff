                                     ...
                                     cudaStream_t stream)
{
  if (N <= std::numeric_limits<uint32_t>::max()) {
    ...
    if (levels.empty()) {
      ...
      for (int i = (int)L - 2; 0 <= i; i--) {
        scan<false, false, false> << <levels[i], blockSize, 0, stream >> > (scratch_d + offsets[l],
                                                                            nullptr,
                                                                            nullptr,
                                                                            scratch_d + offsets[l],
                                                                            levels[l]);
      ...
      scan<false, false, false> << <levels[0], blockSize, 0, stream >> > (offsets_d,
                                                                          nullptr,
                                                                          nullptr,
                                                                          counts_d,
                                                                          n);
